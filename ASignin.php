        ...
        <div>
             ...
             include "conn.inc.php";
              $dbh = new PDO($conn, $user, $pass);
               ...
               $dbh = new PDO($conn,$user,$pass);
               $stm=$dbh->prepare("SELECT * FROM carpool.Autista WHERE (email=:u||username=:u) AND password=MD5(:p);");
              ...
              <div class='row'>
               ...
               <div class='row'>
                ...
                <div class='col-md-4'>
                  <div class='form-group'>
                    <h3>
                      Non sei registrato? <a href='ASignUp.php'>Registrati ora</a>
                    </h3>
                  </div>
                </div>
                <div class='col-md-4'>
